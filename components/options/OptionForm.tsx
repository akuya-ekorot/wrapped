...
import { type TAddOptimistic } from "@/app/(app)/options/useOptimisticOptions";
...
const OptionForm = ({
  ...
  const handleSubmit = async (data: FormData) => {
    ...
    const optionParsed = await insertOptionParams.safeParseAsync({ productId, ...payload });
      ...
      {editing ? (
        <Button
          ...
          onClick={() => {
            ...
            closeModal && closeModal();
            startMutation(async () => {
              addOptimistic && addOptimistic({ action: "delete", data: option });
