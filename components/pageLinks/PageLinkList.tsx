...
import { useOptimisticPageLinks } from '@/app/(app)/admin/page-links/useOptimisticPageLinks';
...
export default function PageLinkList({
  ...
  const { optimisticPageLinks, addOptimisticPageLink } =
    useOptimisticPageLinks(pageLinks);
