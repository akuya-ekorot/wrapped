...
import { type Collection, CompleteCollection } from "@/lib/db/schema/collections";
import Modal from "@/components/shared/Modal";

import { useOptimisticCollections } from "@/app/(app)/collections/useOptimisticCollections";
...
export default function CollectionList({
  ...
  const { optimisticCollections, addOptimisticCollection } = useOptimisticCollections(
    collections,
    ...
    <div className="text-center">
      ...
      <div className="mt-6">
        <Button onClick={() => openModal()}>
          <PlusIcon className="h-4" /> New Collections </Button>
      </div>
    </div>
  );
};
