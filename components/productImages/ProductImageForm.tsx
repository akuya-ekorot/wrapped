...
import { type TAddOptimistic } from "@/app/(app)/product-images/useOptimisticProductImages";
...
import { type ProductImage, insertProductImageParams } from "@/lib/db/schema/productImages";
import {
...
const ProductImageForm = ({
  ...
  const handleSubmit = async (data: FormData) => {
    ...
    const productImageParsed = await insertProductImageParams.safeParseAsync({ imageId,
  productId, ...payload });
      ...
      {editing ? (
        <Button
          ...
          onClick={() => {
            ...
            closeModal && closeModal();
            startMutation(async () => {
              addOptimistic && addOptimistic({ action: "delete", data: productImage });
