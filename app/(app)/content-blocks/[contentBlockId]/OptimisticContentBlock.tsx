...
import { TAddOptimistic } from "@/app/(app)/content-blocks/useOptimisticContentBlocks";
...
export default function OptimisticContentBlock({ 
  ...
  const [optimisticContentBlock, setOptimisticContentBlock] = useOptimistic(contentBlock);
  ...
  return (
    <div className="m-4">
      ...
      <div className="flex justify-between items-end mb-4">
        <h1 className="font-semibold text-2xl">{optimisticContentBlock.title}</h1>
