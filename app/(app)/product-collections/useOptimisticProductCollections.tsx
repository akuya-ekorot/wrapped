...
import { type ProductCollection, type CompleteProductCollection } from "@/lib/db/schema/productCollections";
import { OptimisticAction } from "@/lib/utils";
import { useOptimistic } from "react";

export type TAddOptimistic = (action: OptimisticAction<ProductCollection>) => void;
...
export const useOptimisticProductCollections = (
  ...
  const [optimisticProductCollections, addOptimisticProductCollection] = useOptimistic(
    productCollections,
    (
      ...
      switch (action.action) {
        ...
        case "update":
          return currentState.map((item) =>
            item.id === data.id ? { ...item, ...optimisticProductCollection } : item,
          );
        case "delete":
          return currentState.map((item) =>
