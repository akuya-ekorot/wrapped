...
import { type CollectionImage, type CompleteCollectionImage } from "@/lib/db/schema/collectionImages";
import { OptimisticAction } from "@/lib/utils";
import { useOptimistic } from "react";

export type TAddOptimistic = (action: OptimisticAction<CollectionImage>) => void;
...
export const useOptimisticCollectionImages = (
  ...
  const [optimisticCollectionImages, addOptimisticCollectionImage] = useOptimistic(
    collectionImages,
    (
      ...
      switch (action.action) {
        ...
        case "update":
          return currentState.map((item) =>
            item.id === data.id ? { ...item, ...optimisticCollectionImage } : item,
          );
        case "delete":
          return currentState.map((item) =>
