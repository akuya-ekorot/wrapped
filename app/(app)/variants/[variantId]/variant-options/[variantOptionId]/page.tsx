...
import { getVariants } from "@/lib/api/variants/queries";import OptimisticVariantOption from "@/app/(app)/variant-options/[variantOptionId]/OptimisticVariantOption";
  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="relative">
        ...
        <OptimisticVariantOption variantOption={variantOption} options={options}
        optionId={variantOption.optionId} optionValues={optionValues}
        optionValueId={variantOption.optionValueId} variants={variants}
