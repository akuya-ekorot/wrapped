...
import { getProducts } from "@/lib/api/products/queries";import OptimisticProductImage from "@/app/(app)/product-images/[productImageId]/OptimisticProductImage";
  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="relative">
        ...
        <OptimisticProductImage productImage={productImage} images={images}
        imageId={productImage.imageId} products={products}
