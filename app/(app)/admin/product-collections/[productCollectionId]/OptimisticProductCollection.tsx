...
import { TAddOptimistic } from '@/app/(app)/admin/product-collections/useOptimisticProductCollections';
...
export default function OptimisticProductCollection({
  ...
  const [optimisticProductCollection, setOptimisticProductCollection] =
    useOptimistic(productCollection);
    ...
    <div className="m-4">
      ...
      <div className="flex justify-between items-end mb-4">
        <h1 className="font-semibold text-2xl">
          {optimisticProductCollection.collectionId}
        </h1>
      ...
      <pre
        className={cn(
          ...
          optimisticProductCollection.id === 'optimistic'
            ? 'animate-pulse'
            : '',
        )}
      >
