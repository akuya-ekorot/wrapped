...
import { TAddOptimistic } from "@/app/(app)/variant-options/useOptimisticVariantOptions";
...
export default function OptimisticVariantOption({ 
  ...
  const [optimisticVariantOption, setOptimisticVariantOption] = useOptimistic(variantOption);
